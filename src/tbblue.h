...
#define TBBLUE_CORE_DEFAULT_VERSION_SUBMINOR  5
...
extern const char *tbblue_get_layer2_mode_name(void);
...
extern int tbsprite_do_overlay(void);
...
extern z80_byte tbblue_port_123b_b4;
...
extern z80_byte tbsprite_pattern_get_value_index(z80_byte pattern_7b_id,z80_byte byte_offset);

extern void tbsprite_pattern_put_value_index(z80_byte pattern_7b_id,z80_byte byte_offset,z80_byte value);
...
extern void get_ula_pixel_9b_color_tbblue(z80_byte attribute,z80_int *tinta_orig, z80_int *papel_orig);
